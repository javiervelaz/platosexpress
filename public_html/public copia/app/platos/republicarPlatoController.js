...
republicar.$inject = ['$scope', 'model', 'Notification', '$route','errorHandler','platosData','$location','SystemUser'];

function republicar($scope, model, Notification, $route,errorHandler,platosData,$location,SystemUser) {
    var domain = 'platos'
