angular
        .module('app')
        .controller('createUserTwitterController',twitterUser)

twitterUser.$inject = ['$scope', 'dataService', '$location', 'userDomain', 'Notification', 'errorHandler',$route];

function twitterUser($scope, dataService, $location, userDomain, Notification, errorHandler,$route){
    $scope.nombre = $route.current.params.data;
    var domain = 'users';
