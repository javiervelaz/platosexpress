...
$asunto = "PLATOS EXPRESS : Respuesta";	
$body =  str_replace("*|FNAME|*",$email, $hola);
$body =  str_replace("*|PREG|*",$texto, $body);
$body =  str_replace("*|HTEXTO|*","Usted ha recibido una respuesta.", $body);
$body =  str_replace("*|TITULO|*","Respuesta", $body);
$body =  str_replace("*|TEXTO2|*","Usted ha recibido una respuesta:", $body);
...
$asunto = "PLATOS EXPRESS : COMPRA";	
$body =  str_replace("*|FNAME|*",$email, $hola);
$body =  str_replace("*|PREG|*",$texto, $body);
$body =  str_replace("*|HTEXTO|*","Gracias por comprar en Platos Express.", $body);
$body =  str_replace("*|TITULO|*","COMPRA", $body);
$body =  str_replace("*|TEXTO2|*","Gracias por comprar en Platos Express:", $body);
...
$asunto = "PLATOS EXPRESS : VENTA";	
$body =  str_replace("*|FNAME|*",$email, $hola);
$body =  str_replace("*|PREG|*",$texto, $body);
$body =  str_replace("*|HTEXTO|*","Usted ha realizado una venta.", $body);
$body =  str_replace("*|TITULO|*","Venta", $body);
$body =  str_replace("*|TEXTO2|*","Usted ha realizado una venta:", $body);
